...
import com.example.easytolearn.databinding.ActivityChemistryBinding;
...
public class Chemistry extends AppCompatActivity implements ChapterListCallback {
    String subName;
    private Context context;
    private ActivityChemistryBinding binding;
    private List<ChapterListResponse.ResponseBean> list=new ArrayList<>();
    private ChapterListAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        binding= DataBindingUtil.setContentView(this,R.layout.activity_chemistry );
        context=this;
        Intent in=getIntent();
    ...
    private void chapterList(){
        ...
        chapterListRequest.put("Subject","Chemistry");
    ...
    public void onSuccess(List<ChapterListResponse.ResponseBean> address) {
        list.clear();
        list.addAll(address);
        binding.recyclerChemistry.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false));
       // adapter = new ChapterListAdapter(subName,list, context);
        binding.recyclerChemistry.setAdapter(adapter);
    }
